  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <SignUpButton mode="modal">
        <Button
          size="sm"
          className="text-sm bg-violet-600 hover:bg-violet-500 text-white border-0 shadow-lg shadow-violet-900/30"
        >
          Sign up
        </Button>
      </SignUpButton>
...
export function Navbar() {
  ...
  return (
    <nav className={cn(
      ...
      scrolled
        ? 'bg-background/80 backdrop-blur-2xl border-b border-white/[0.06] shadow-[0_1px_0_0_rgba(255,255,255,0.04)]'
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          {/* Nav links */}
          <div className="hidden sm:flex items-center gap-0.5 mr-3">
            {navItems.map(item => {
