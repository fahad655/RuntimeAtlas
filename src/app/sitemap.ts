...
const STATIC_PAGES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/blog/ios-26-to-ios-27-migration`,                         priority: 0.8, changeFrequency: 'weekly' },
  { url: `${BASE}/blog/ios-27-deprecations-breaking-changes`,               priority: 0.8, changeFrequency: 'weekly' },
  { url: `${BASE}/blog/realitykit-usdkit-ios-27-spatial-computing`,         priority: 0.7, changeFrequency: 'weekly' },
  { url: `${BASE}/blog/swiftchronicle-mcp-ai-coding-assistant-guide`,       priority: 0.6, changeFrequency: 'monthly' },
